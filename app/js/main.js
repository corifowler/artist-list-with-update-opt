...
var APP_ID = 'kE616t2jfc6thbZFqNgsrbOddZyIYz6PWha334Mr';
var API_KEY = 'hlISmce1ln6HF06U0YTwTE2vlaH79aX6JER2ECqa';
...
},{"./artist":3,"./artists":4}],6:[function(require,module,exports){
'use strict';
...
exports['default'] = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el = appElement;
    this.collection = new _resources.Artists();
    ...
    this.$el.on('click', '.artist-list-item', function (event) {
      ...
      _this.navigate('artist/' + artistId, { trigger: true });
    });
  ...
  redirectToArtists: function redirectToArtists() {
    this.navigate('artists', { replace: true, trigger: true });
  },

  showArtists: function showArtists() {
    var _this2 = this;

    this.showSpinner();
    this.collection.fetch().then(function () {
      _this2.$el.html((0, _views.Artists)(_this2.collection.toJSON()));
    });
  },

  showArtist: function showArtist(id) {
    var _this3 = this;

    var artist = this.collection.get(id);

    if (artist) {
      this.$el.html((0, _views.Artist)(artist.toJSON()));
    } else {
      this.showSpinner();
